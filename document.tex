...
\subsection{Definition of the sensor class}
\input{./latexClasses/latexPositionSensor}

\subsection{Robot Controller}
\input{latexClasses/latexRobotController.tex}
\input{latexClasses/latexRobotPositionSensor.tex}
\input{latexClasses/latexPositionController.tex}
